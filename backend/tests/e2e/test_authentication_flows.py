...
class TestAuthenticationFlows:
    ...
    def test_complete_user_onboarding_flow(self, e2e_test_base: E2ETestBase, test_data_factory):
    ...
    def test_login_logout_flow(self, e2e_test_base: E2ETestBase):
        ...
        nonexistent_login = client.post("/api/v1/auth/login", json={
    ...
    def test_password_change_flow(self, e2e_test_base: E2ETestBase):
        ...
        wrong_change_response = client.post("/api/v1/auth/change-password", json=wrong_change_data, headers=headers)
    ...
    def test_profile_management_flow(self, e2e_test_base: E2ETestBase):
        ...
        update_response = client.put("/api/v1/auth/me", json=updated_data, headers=headers)
    ...
    def test_company_management_flow(self, e2e_test_base: E2ETestBase):
        ...
        company_response = client.get("/api/v1/auth/company", headers=headers)
        e2e_test_base.assert_response_error(company_response, 403)  # No company association
        ...
        create_response = client.post("/api/v1/auth/company", json=company_data, headers=headers)
        ...
        another_create_response = client.post("/api/v1/auth/company", json=another_company_data, headers=headers)
...
class TestRoleBasedAccessControl:
    ...
    def test_viewer_permissions(self, e2e_test_base: E2ETestBase):
        ...
        manager_data = e2e_test_base.test_data_factory.create_user_data(company_id=company.id)
        ...
        view_response = client.get(f"/api/v1/contracts/{contract.id}", headers=viewer_headers)
        ...
        create_response = client.post("/api/v1/contracts/", json=contract_data, headers=viewer_headers)
        # e2e_test_base.assert_response_error(create_response, 403)
        
        # Test 3: Cannot delete contracts (assuming role restrictions)
        delete_response = client.delete(f"/api/v1/contracts/{contract.id}", headers=viewer_headers)
...
class TestMultiUserScenarios:
    ...
    def test_company_isolation(self, e2e_test_base: E2ETestBase):
        ...
        access_response = client.get(f"/api/v1/contracts/{contract_b.id}", headers=headers_a)
        e2e_test_base.assert_response_error(access_response, 403)
        
        # Test 4: User B cannot access User A's contract directly
        access_response = client.get(f"/api/v1/contracts/{contract_a.id}", headers=headers_b)
        e2e_test_base.assert_response_error(access_response, 403)
    ...
    def test_concurrent_user_operations(self, e2e_test_base: E2ETestBase):
        ...
        # Create contracts
        response_1 = client.post("/api/v1/contracts/", json=contract_data_1, headers=headers_1)
        response_2 = client.post("/api/v1/contracts/", json=contract_data_2, headers=headers_2)
        response_3 = client.post("/api/v1/contracts/", json=contract_data_3, headers=headers_3)
        ...
        list_response = client.get("/api/v1/contracts/", headers=headers_1)  # Any user can list company contracts
        e2e_test_base.assert_response_success(list_response)
