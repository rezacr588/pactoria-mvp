...
class TestContractReconstruction:
    ...
    def test_contract_can_be_reconstructed_from_persistence_without_breaking_encapsulation(self):
    ...
    def test_reconstructed_contract_maintains_business_rules(self):
        ...
        with pytest.raises(Exception):  # Should not be able to activate already active contract
