...
class ContractSearchFilters(BaseModel):
    ...
    status: Optional[List[str]] = Field(
        None, description="Contract statuses to filter by"
    )
    contract_type: Optional[List[str]] = Field(
        None, description="Contract types to filter by"
    )
    ...
    contract_value: Optional[NumericRangeFilter] = Field(
        None, description="Contract value range"
    )
    ...
    created_at: Optional[DateRangeFilter] = Field(
        None, description="Creation date range"
    )
    updated_at: Optional[DateRangeFilter] = Field(
        None, description="Last updated date range"
    )
    has_compliance_score: Optional[bool] = Field(
        None, description="Filter by compliance score presence"
    )
    compliance_score: Optional[NumericRangeFilter] = Field(
        None, description="Compliance score range"
    )
    risk_score: Optional[NumericRangeFilter] = Field(
        None, description="Risk score range"
    )
    template_id: Optional[List[str]] = Field(
        None, description="Template IDs to filter by"
    )
...
class UserSearchFilters(BaseModel):
    ...
    department: Optional[List[str]] = Field(
        None, description="Departments to filter by"
    )
    created_at: Optional[DateRangeFilter] = Field(
        None, description="User creation date range"
    )
    last_login_at: Optional[DateRangeFilter] = Field(
...
class TemplateSearchFilters(BaseModel):
    ...
    category: Optional[List[str]] = Field(
        None, description="Template categories to filter by"
    )
    is_active: Optional[bool] = Field(None, description="Filter by active status")
    suitable_for: Optional[List[str]] = Field(
        None, description="Industries or use cases"
    )
...
class AdvancedSearchRequest(BaseModel):
    ...
    operator: SearchOperator = Field(
        SearchOperator.AND, description="Query operator for multiple terms"
    )
    fields: Optional[List[str]] = Field(None, description="Fields to search in")
    filters: Union[ContractSearchFilters, UserSearchFilters, TemplateSearchFilters] = (
        Field(..., description="Advanced filters")
    )
...
class ContractSearchRequest(BaseModel):
    ...
    fields: Optional[List[str]] = Field(None, description="Fields to search in")
    filters: ContractSearchFilters = Field(
        ContractSearchFilters(), description="Contract filters"
    )
    sort: Optional[List[SortCriteria]] = Field(None, description="Sort criteria")
    page: int = Field(1, ge=1, le=1000, description="Page number")
    size: int = Field(20, ge=1, le=1000, description="Results per page")
...
class TemplateSearchRequest(BaseModel):
    ...
    filters: TemplateSearchFilters = Field(
        TemplateSearchFilters(), description="Template filters"
    )
    sort: Optional[List[SortCriteria]] = Field(None, description="Sort criteria")
    page: int = Field(1, ge=1, le=1000, description="Page number")
    size: int = Field(20, ge=1, le=1000, description="Results per page")
...
class ContractSearchResult(BaseModel):
    ...
    highlights: Optional[List[SearchHighlight]] = Field(
        None, description="Search term highlights"
    )
