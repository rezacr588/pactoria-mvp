...
from app.schemas.bulk import (
    BulkContractUpdateRequest, BulkContractDeleteRequest, BulkUserInviteRequest,
    BulkUserRoleChangeRequest, BulkOperationError, UserInvitation, ContractBulkUpdateFields
)
...
class TestBulkContractUpdate:
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_contracts_success(self, bulk_service, mock_db, contract_manager_user, sample_contracts):
        ...
        with patch('app.core.datetime_utils.get_current_utc') as mock_utc:
            ...
            # When
            result = await bulk_service.bulk_update_contracts(request, contract_manager_user)
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_contracts_insufficient_permissions(self, bulk_service, mock_db, viewer_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_contracts_limit_exceeded(self, bulk_service, mock_db, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_contracts_not_found(self, bulk_service, mock_db, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_contracts_partial_failure(self, bulk_service, mock_db, admin_user, sample_contracts):
        ...
        with patch('app.core.datetime_utils.get_current_utc') as mock_utc:
            ...
            with patch.object(bulk_service, '_apply_contract_updates') as mock_apply:
                mock_apply.side_effect = lambda contract, updates: (
                    False if contract.id == faulty_contract.id 
                    else True
                )
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_contracts_database_rollback(self, bulk_service, mock_db, admin_user, sample_contracts):
...
class TestBulkContractDelete:
    ...
    @pytest.mark.asyncio
    async def test_bulk_delete_contracts_success(self, bulk_service, mock_db, admin_user, sample_contracts):
    ...
    @pytest.mark.asyncio
    async def test_bulk_delete_contracts_cannot_delete_active(self, bulk_service, mock_db, admin_user, sample_contracts):
    ...
    @pytest.mark.asyncio
    async def test_bulk_delete_contracts_insufficient_permissions(self, bulk_service, mock_db, viewer_user):
...
class TestBulkUserInvite:
    ...
    @pytest.mark.asyncio
    async def test_bulk_invite_users_existing_same_company(self, bulk_service, mock_db, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_invite_users_existing_other_company(self, bulk_service, mock_db, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_invite_users_non_admin(self, bulk_service, mock_db, contract_manager_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_invite_users_limit_exceeded(self, bulk_service, mock_db, admin_user):
...
class TestBulkUserRoleChange:
    ...
    @pytest.mark.asyncio
    async def test_bulk_change_user_roles_success(self, bulk_service, mock_db, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_change_user_roles_cannot_change_own_role(self, bulk_service, mock_db, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_change_user_roles_cannot_demote_last_admin(self, bulk_service, mock_db, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_bulk_change_user_roles_same_role(self, bulk_service, mock_db, admin_user):
...
class TestHelperMethods:
    ...
    def test_ensure_bulk_operation_permissions_contract_manager(self, bulk_service, contract_manager_user):
    ...
    def test_ensure_admin_permissions_non_admin(self, bulk_service, contract_manager_user):
    ...
    def test_apply_contract_updates_multiple_fields(self, bulk_service, sample_contracts):
