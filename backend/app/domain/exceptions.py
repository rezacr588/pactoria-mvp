...
class ContractNotFoundError(DomainError):
    ...
    def __init__(self, contract_id: str):
        super().__init__(
            f"Contract with ID '{contract_id}' not found", "CONTRACT_NOT_FOUND"
        )
...
class ResourceNotFoundError(DomainError):
    ...
    def __init__(self, resource_type: str, resource_id: str):
        super().__init__(
            f"{resource_type} with ID '{resource_id}' not found", "RESOURCE_NOT_FOUND"
        )
...
class ContractStateError(BusinessRuleViolationError):
    ...
    def __init__(
        self, message: str, current_status: str, required_status: Optional[str] = None
    ):
        super().__init__(
            message,
...
class PermissionDeniedError(DomainError):
    ...
    def __init__(
        self, message: str, user_id: str, resource_type: str, resource_id: str
    ):
...
class ConcurrencyError(DomainError):
    ...
    def __init__(
        self, message: str, entity_id: str, expected_version: int, actual_version: int
    ):
...
class AIServiceError(DomainError):
    ...
    def __init__(self, message: str, service_name: str, operation: str):
        ...
        self.details.update({"service_name": service_name, "operation": operation})
...
class CompanyLimitExceededError(DomainError):
    ...
    def __init__(
        self, message: str, limit_type: str, current_value: int, max_allowed: int
    ):
