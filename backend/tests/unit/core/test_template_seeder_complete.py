...
class TestGetUkLegalTemplates:
    ...
    def test_get_uk_legal_templates_includes_gdpr_content(self):
        ...
        has_gdpr_content = any(
            "gdpr" in template["template_content"].lower() or
            "data protection" in template["template_content"].lower() or
            "gdpr" in " ".join(template.get("tags", [])).lower()
            for template in templates
        )
...
class TestSeedTemplatesFunction:
    ...
    def test_seed_templates_template_already_exists(self, mock_db, sample_template_data):
...
class TestTemplateDataValidation:
    ...
    def test_all_templates_have_required_fields(self):
        ...
        required_fields = [
            ...
            "template_content", "is_default", "tags", "created_by_system"
        ]
    ...
    def test_template_content_contains_uk_specific_terms(self):
        ...
        uk_terms = [
            "united kingdom", "uk", "british", "england", "wales", "scotland",
            "gdpr", "data protection act", "employment rights act",
            "companies house", "hmrc", "vat"
        ]
...
class TestErrorScenarios:
    ...
    def test_seed_templates_rollback_called_on_commit_error(self, mock_db):
        ...
        with patch('app.core.template_seeder.get_uk_legal_templates') as mock_get_templates:
    ...
    def test_seed_templates_handles_template_creation_error(self, mock_db):
        ...
        with patch('app.core.template_seeder.get_uk_legal_templates') as mock_get_templates:
            ...
            with patch('app.core.template_seeder.Template', side_effect=ValueError("Invalid contract type")):
                seed_templates(mock_db)
