...
class TestTableCreation:
    ...
    async def test_create_tables_success(self):
        ...
        with patch('app.core.database.Base.metadata') as mock_metadata, \
...
class TestDatabaseManager:
    ...
    async def test_reset_database_development(self):
        ...
        with patch('app.core.database.settings') as mock_settings, \
             patch('app.core.database.Base.metadata') as mock_metadata, \
             patch('app.core.database.create_tables') as mock_create_tables, \
             patch('app.core.database.engine') as mock_engine:
    ...
    async def test_reset_database_production(self):
        ...
        with patch('app.core.database.settings') as mock_settings:
            ...
            with pytest.raises(Exception, match="Database reset only allowed in development"):
                await DatabaseManager.reset_database()
