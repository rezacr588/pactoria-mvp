...
from app.core.responses import (
    ResponseFormatter, APIResponse, MessageTemplates
)
...
class TestAPIResponse:
    ...
    def test_api_response_init_basic(self):
        ...
        response = APIResponse(data={"test": "data"}, message="Success", status_code=200)
    ...
    def test_api_response_created_class_method_with_params(self):
        ...
        response = APIResponse.created(data=test_data, message="Contract created successfully")
