...
class APIExceptionFactory:
    ...
    @staticmethod
    def forbidden(detail: str = "Access denied: insufficient permissions") -> HTTPException:
    ...
    @staticmethod
    def unprocessable_entity(detail: str, errors: Optional[Dict[str, Any]] = None) -> HTTPException:
...
class CompanyAccessError(Exception):
    ...
    def __init__(self, detail: str = "Access denied: insufficient permissions for company resource"):
        self.detail = detail
