...
from app.domain.entities.company import (
    ...
    CompanyRegistered, CompanyVerified, CompanyDetailsUpdated
)
...
class TestCompanyNumber:
    ...
    def test_invalid_company_numbers(self):
        ...
        for number in invalid_numbers:
            with pytest.raises(DomainValidationError, match="Invalid UK company number"):
...
class TestBusinessAddress:
    ...
    def test_invalid_address_missing_required_fields(self):
        ...
        with pytest.raises(DomainValidationError, match="Address line 1 cannot be empty"):
...
class TestCompany:
    ...
    def test_verify_without_company_number_fails(self, valid_company_data):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Cannot verify company without company number"):
    ...
    def test_invalid_subscription_tier(self, valid_company_data):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Invalid subscription tier"):
    ...
    def test_increment_monthly_contracts(self, valid_company_data):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Monthly contract limit reached"):
            company.increment_monthly_contracts()
