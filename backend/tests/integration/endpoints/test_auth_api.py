...
class TestAuthAPI:
    ...
    def test_get_user_company(self, client):
        ...
        with patch("app.api.v1.endpoints.auth.get_current_user") as mock_get_user:
            ...
            response = client.get(
                "/api/v1/auth/company", headers={"Authorization": "Bearer mock_token"}
            )
    ...
    def test_update_company_as_non_admin(self, client):
        ...
        with patch("app.api.v1.endpoints.auth.get_current_user") as mock_get_user:
            ...
            update_data = {"name": "Unauthorized Update Ltd"}
    ...
    def test_logout_user(self, client):
        ...
        with patch("app.api.v1.endpoints.auth.get_current_user") as mock_get_user:
            ...
            response = client.post(
                "/api/v1/auth/logout", headers={"Authorization": "Bearer mock_token"}
            )
