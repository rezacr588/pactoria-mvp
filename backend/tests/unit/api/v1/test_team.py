...
class TestGetTeamMembers:
    ...
    def test_get_team_members_with_filters(self, mock_auth):
        ...
        params = {"include_inactive": True, "role": "editor", "department": "Legal"}
...
class TestResendInvitation:
    ...
    def test_resend_invitation_success(self, mock_auth):
        ...
        response = client.post(
            f"/api/v1/team/members/{member_id}/resend-invite", json=resend_data
        )
        ...
        if members:
            ...
            if member_id != "test_user_123":  # Don't try to remove self
                ...
                role_response = client.put(
                    f"/api/v1/team/members/{member_id}/role", json={"role": "editor"}
                )
