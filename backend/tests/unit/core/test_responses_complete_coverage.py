...
class TestResponseFormatter:
    ...
    def test_operation_completed(self):
        ...
        response = ResponseFormatter.operation_completed(
            "Data export", {"file": "data.csv"}
        )
...
class TestMessageTemplates:
    ...
    def test_format_template_with_multiple_params(self):
        ...
        formatted = MessageTemplates.format(
            MessageTemplates.OPERATION_FAILED, operation="Backup", reason="disk full"
        )
...
class TestPerformanceAndMemory:
    ...
    def test_large_paginated_response(self):
        ...
        response = PaginatedResponse.create(
            items=items, total=100000, page=50, size=1000
        )
