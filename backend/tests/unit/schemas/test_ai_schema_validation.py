...
from app.schemas.ai import ContractAnalysisRequest, TemplateRecommendationRequest
...
class TestContractAnalysisRequestValidation:
    ...
    def test_contract_content_edge_case_lengths(self):
        ...
        request_50 = ContractAnalysisRequest(
            contract_content=content_50, contract_type="service_agreement"
        )
        ...
        with pytest.raises(ValidationError):
            ContractAnalysisRequest(
                contract_content=content_49, contract_type="service_agreement"
            )
    ...
    def test_contract_content_with_whitespace(self):
        ...
        if len(content_with_spaces.strip()) >= 50:
            request = ContractAnalysisRequest(
                contract_content=content_with_spaces, contract_type="service_agreement"
            )
        ...
        with pytest.raises(ValidationError):
            ContractAnalysisRequest(
                contract_content=short_with_spaces, contract_type="service_agreement"
            )

    def test_contract_content_with_special_characters(self):
        """Test contract content with special characters"""
        special_content = (
            "Contract with special chars: €100, 50% deposit, & more términos legales! 🎉"
            * 2
        )

        request = ContractAnalysisRequest(
            contract_content=special_content, contract_type="service_agreement"
        )
    ...
    def test_contract_content_with_newlines(self):
        ...
        if len(multiline_content.strip()) >= 50:
            request = ContractAnalysisRequest(
                contract_content=multiline_content, contract_type="service_agreement"
            )
...
class TestTemplateRecommendationRequestValidation:
    ...
    def test_business_description_edge_case_lengths(self):
        ...
        request_20 = TemplateRecommendationRequest(
            business_description=description_20, industry="consulting"
        )
        ...
        with pytest.raises(ValidationError):
            TemplateRecommendationRequest(
                business_description=description_19, industry="consulting"
            )
    ...
    def test_business_description_with_whitespace(self):
        ...
        if len(description_with_spaces.strip()) >= 20:
            request = TemplateRecommendationRequest(
                business_description=description_with_spaces, industry="consulting"
            )
        ...
        with pytest.raises(ValidationError):
            TemplateRecommendationRequest(
                business_description=short_with_spaces, industry="consulting"
            )

    def test_business_description_with_special_characters(self):
        """Test business description with special characters"""
        special_description = (
            "My business focuses on IT solutions & consulting for SMEs (€50K+ revenue)"
        )

        request = TemplateRecommendationRequest(
            business_description=special_description, industry="technology"
        )
    ...
    def test_business_description_with_newlines(self):
        ...
        if len(multiline_description.strip()) >= 20:
            request = TemplateRecommendationRequest(
                business_description=multiline_description, industry="legal"
            )
...
class TestValidationErrorMessages:
    ...
    def test_contract_content_validation_error_message(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ContractAnalysisRequest(
                contract_content="short", contract_type="service_agreement"
            )
    ...
    def test_business_description_validation_error_message(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            TemplateRecommendationRequest(
                business_description="short", industry="consulting"
            )
...
class TestEdgeCases:
    ...
    def test_unicode_content(self):
        ...
        unicode_content = (
            "Contrato con acentos: ñ, ü, ç. And emojis: 📄 ⚖️ 🏢" + " " + "x" * 50
        )

        request = ContractAnalysisRequest(
            contract_content=unicode_content, contract_type="service_agreement"
        )
    ...
    def test_very_long_content(self):
        ...
        long_content = (
            "This is a very long contract content. " * 1000
        )  # ~38,000 characters

        request = ContractAnalysisRequest(
            contract_content=long_content, contract_type="service_agreement"
        )
    ...
    def test_null_and_empty_values(self):
        ...
        with pytest.raises(ValidationError):
            ContractAnalysisRequest(
                contract_content="", contract_type="service_agreement"
            )

        # Test None value (should fail validation)
        with pytest.raises(ValidationError):
            ContractAnalysisRequest(
                contract_content=None, contract_type="service_agreement"
            )
