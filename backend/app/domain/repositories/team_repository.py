...
class TeamRepository(ABC):
    ...
    @abstractmethod
    async def get_member_by_id(self, company_id: str, member_id: str) -> Optional[TeamMember]:
        """Get team member by ID within a company"""
        pass
    
    @abstractmethod
    async def get_invitation_by_id(self, invitation_id: str) -> Optional[TeamInvitation]:
    ...
    @abstractmethod
    async def find_expired_invitations(self, company_id: Optional[str] = None) -> List[TeamInvitation]:
