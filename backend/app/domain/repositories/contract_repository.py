...
class ContractFilter:
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.supplier_name == other.supplier_name
            and self.title_contains == other.title_contains
            and self.created_after == other.created_after
            and self.created_before == other.created_before
