...
class EventPublishingFactory:
    ...
    def create_publisher(
        ...
        logger.info(f"Created {publisher_type} domain event publisher with {publisher.get_handler_count()} handlers")
        return publisher
    ...
    def _register_contract_handlers(
        ...
        activated_handler = ContractActivatedEventHandler(notification_service, audit_service)
        publisher.register_handler("ContractActivated", activated_handler)
        
        # Contract Completed Handler
        completed_handler = ContractCompletedEventHandler(notification_service, audit_service)
        publisher.register_handler("ContractCompleted", completed_handler)
        
        # Contract Terminated Handler
        terminated_handler = ContractTerminatedEventHandler(notification_service, audit_service)
