...
class TestContractAPI:
    ...
    def test_contract_generation_invalid_request(self, client, invalid_contract_request):
    ...
    def test_contract_generation_ai_service_failure(self, client, valid_contract_request):
    ...
    def test_contract_generation_with_all_parameters(self, client):
        ...
        with patch('app.api.v1.endpoints.contracts.ai_service') as mock_ai_service:
            ...
            assert call_args["company_details"] == comprehensive_request["company_details"]
    ...
    def test_response_schemas_compliance(self, client, valid_contract_request):
        ...
        with patch('app.api.v1.endpoints.contracts.ai_service') as mock_ai_service:
            ...
            contract = data["contract"]
            contract_fields = [
                "id", "title", "contract_type", "status", "version",
                "plain_english_input", "generated_content", "created_by",
