...
class ResponseFormatter:
    ...
    @staticmethod
    def created(
        resource_name: str, resource_id: str, data: Optional[Dict[str, Any]] = None
    ) -> SuccessResponse:
    ...
    def updated(resource_name: str, resource_id: str) -> SuccessResponse:
        ...
        return SuccessResponse(
            message=f"{resource_name} updated successfully", data={"id": resource_id}
        )
    ...
    def deleted(resource_name: str, resource_id: str) -> SuccessResponse:
        ...
        return SuccessResponse(
            message=f"{resource_name} deleted successfully", data={"id": resource_id}
        )
    ...
    def operation_completed(
        ...
        return SuccessResponse(
            message=f"{operation} completed successfully", data=details
        )

    @staticmethod
    def paginated_list(
        items: List[Any], total: int, page: int, size: int, resource_name: str = "items"
    ) -> PaginatedResponse:
...
class MessageTemplates:
    ...
    COMPANY_ACCESS_DENIED = (
        "Access denied: insufficient permissions for company resource"
    )
...
class APIResponse:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        response = {"timestamp": self.timestamp, "status_code": self.status_code}
    ...
    @classmethod
    def created(
        cls, data: Any = None, message: str = "Resource created successfully"
    ) -> "APIResponse":
