...
class ContractAnalysisResponse(BaseModel):
    ...
    gdpr_compliance: float = Field(..., ge=0.0, le=1.0, description="GDPR compliance score")
    employment_law_compliance: Optional[float] = Field(None, ge=0.0, le=1.0, description="Employment law compliance")
    consumer_rights_compliance: Optional[float] = Field(None, ge=0.0, le=1.0, description="Consumer rights compliance")
    commercial_terms_compliance: float = Field(..., ge=0.0, le=1.0, description="Commercial terms compliance")
...
class TemplateRecommendationRequest(BaseModel):
    ...
    business_description: str = Field(..., min_length=20, description="Business context and requirements")
...
class AIUsageStats(BaseModel):
    ...
    model_accuracy: float = Field(..., ge=0.0, le=1.0, description="Model accuracy score")
    uptime_percentage: float = Field(..., ge=0.0, le=100.0, description="Service uptime percentage")